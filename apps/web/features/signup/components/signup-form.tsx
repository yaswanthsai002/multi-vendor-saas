    ...
    <div className="w-full h-full max-w-lg px-4 py-2 sm:px-6 lg:px-0">
      ...
      <div className="mb-6 text-left">
        ...
        <p className="mt-1.5 text-sm text-text-secondary font-normal">
          Create your Perigee account and start exploring.
        </p>
      </div>

      {/* Signup Form */}
      <form onSubmit={onSubmit} noValidate aria-label="Sign up for Perigee" className="space-y-4">
        {/* Full Name */}
        <FormField name="fullName">
          <Label htmlFor="fullName" isRequired>
            Full name
          </Label>
          <Input
            id="fullName"
